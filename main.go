...
func (s *server) handleSelect(w http.ResponseWriter, r *http.Request) {
	...
	portNumber, err := parseSelectedPort(r)
...
func parseSelectedPort(r *http.Request) (int, error) {
	...
	return strconv.Atoi(r.FormValue("port"))
}
...
func isCurl(r *http.Request) bool {
	return strings.HasPrefix(strings.ToLower(r.UserAgent()), "curl/") || strings.HasPrefix(strings.ToLower(r.UserAgent()), "homeassistant/")
}
